...
contract CofounditICO is owned{
	...
	string icoStartedMessage = "";
	string icoMinTresholdReachedMessage = "";
	string icoEndedSuccessfulyMessage = "";
	string icoEndedSuccessfulyWithCapMessage = "";
	string icoFailedMessage = "";
